!(function () {
  ...
  const o = (e) => (t) => t.options.get(e),
    ...
    l = (e, t, o, s) => {
      const n = parseInt(e.getStyle(t, o, s) ?? '', 10);
      return isNaN(n) ? 0 : n;
    },
    a = (e, o, r, c) => {
      const d = e.dom,
      ...
      const m = h.documentElement,
        u = c ? c() : i(e),
        f = s(e) ?? e.getElement().offsetHeight;
      let p = f;
      const y = l(d, m, 'margin-top', !0),
        S = l(d, m, 'margin-bottom', !0);
      let C = m.offsetHeight + y + S + u;
      C < 0 && (C = 0);
      const H = e.getContainer().offsetHeight - e.getContentAreaContainer().offsetHeight;
      C + H > f && (p = C + H);
      const b = n(e);
      b && p > b ? ((p = b), g(e, !0)) : g(e, !1);
      const w = o.get();
      if (
        (w.set &&
          (e.dom.setStyles(e.getDoc().documentElement, { 'min-height': 0 }),
          e.dom.setStyles(e.getBody(), { 'min-height': 'inherit' })),
        p !== w.totalHeight && (C - u !== w.contentHeight || !w.set))
      ) {
        const s = p - w.totalHeight;
        if (
          (d.setStyle(e.getContainer(), 'height', p + 'px'),
          o.set({ totalHeight: p, contentHeight: C, set: !0 }),
          ((e) => {
        ...
        (e.hasFocus() &&
          ((e) => {
            if ('setcontent' === e?.type.toLowerCase()) {
              const t = e;
