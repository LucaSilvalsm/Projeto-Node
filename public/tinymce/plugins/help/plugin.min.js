    ...
    ((e) => {
      ...
      return null === e
        ...
        : 'object' === t && Array.isArray(e)
          ...
          : 'object' === t &&
              ((n = a = e),
              (r = String).prototype.isPrototypeOf(n) || a.constructor?.name === r.name)
            ? 'string'
            : t;
      var n, a, r;
    })(e);
          ...
          ((e, t, n) => {
            ...
            (e) => {
              ...
              return {
                ...
                html: o({
                  name: t,
                  url: `https://www.tiny.cloud/docs/tinymce/${tinymce.majorVersion}/${e.slug}/`,
                }),
              };
            }
          );
        ...
        p = (e) => {
          const n = ((e) => {
              const n = l(e.plugins),
                a = v(e),
                r = t(a)
                  ? ['onboarding', 'licensekeymanager']
                  : a.concat(['onboarding', 'licensekeymanager']);
              return m(n, (e) => !(((e, t) => i.call(e, t))(r, e) > -1));
            })(e),
            a = c(
              s(n, (t) => u(e, t)),
    ...
    (async (t, n, a) => {
      const o = _(),
        ...
        c = (() => {
          var e, t;
          const n =
            '<a data-alloy-tabstop="true" tabindex="-1" href="https://www.tiny.cloud/docs/tinymce/8/changelog/?utm_campaign=help_dialog_version_tab&utm_source=tiny&utm_medium=referral" rel="noopener" target="_blank">TinyMCE ' +
            ((e = O.majorVersion),
            (t = O.minorVersion),
        ...
        u = { [o.name]: o, [i.name]: i, [m.name]: m, [c.name]: c, ...n.get() };
