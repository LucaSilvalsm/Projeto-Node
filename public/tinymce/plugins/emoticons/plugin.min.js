    ...
    L = (t, e) =>
      ...
      ((t) => {
        for (let n = 0, s = t.length; n < s; n++)
          if (((o = t[n]), f(o.toLowerCase(), e))) return !0;
        var o;
        return !1;
      })(t.keywords),
    S = (t, e, o) => {
      ...
      for (
        ...
        o < t.length &&
        ((0 !== e.length && !L(t[o], s)) ||
          (n.push({ value: t[o].char, text: t[o].title, icon: t[o].char }), !r(n.length)));
        o++
      );
      return n;
    },
    ...
    T = (t, e) => {
      const n = { pattern: '', results: S(e.listAll(), '', i.some(300)) },
        ...
        r = ((t) => {
          ...
          ((t) => {
            const o = t.getData(),
              n = s.get(),
              r = e.listCategory(n),
              a = S(r, o[N], n === k ? i.some(300) : i.none());
            t.setData({ results: a });
          })(t);
        }),
        ...
        u = () => ({
          ...
          body: {
            type: 'tabpanel',
            tabs: l(e.listCategories(), (t) => ({ title: t, name: t, items: [a, c] })),
          },
          initialData: n,
          onTabChange: (t, e) => {
            (s.set(e.newTabName), r.throttle(t));
          },
          onChange: r.throttle,
          onAction: (e, o) => {
            'results' === o.name &&
      ...
      (g.focus(N),
        e.hasLoaded() ||
          ...
          e
            .waitForLoad()
            .then(() => {
              (g.redial(u()), r.throttle(g), g.focus(N), g.unblock());
            })
            .catch((t) => {
              (g.redial({
                title: 'Emojis',
    ...
    const o = ((t, e, o) => {
        ...
        a = (t) => {
          return (
            ...
            (e = t.char).length >= 4 && e.substr(0, 4) === o
              ? t.char.replace(/src="([^"]+)"/, (t, e) => `src="${r}${e}"`)
              : t.char
          );
          var e, o;
        };
      t.on('init', () => {
        v.load(o, e).then(
          ...
          (t) => {
            (console.log(`Failed to load emojis: ${t}`), n.set({}), s.set([]));
          }
        );
      });
      const l = () => s.get().getOr([]),
            ...
            : new Promise((t, o) => {
                ...
                const s = setInterval(() => {
                  u()
                    ...
                    : (n--,
                      n < 0 &&
                        (console.log('Could not load emojis from url: ' + e),
                        clearInterval(s),
                        o(!1)));
                }, 100);
              }),
