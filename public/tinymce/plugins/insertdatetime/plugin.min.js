  ...
  const t = (e) => (t) => t.options.get(e),
    ...
    d = (e, t, a = new Date()) =>
      (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = t.replace(
        '%D',
        '%m/%d/%Y'
      )).replace('%r', '%I:%M:%S %p')).replace('%Y', '' + a.getFullYear())).replace(
        '%y',
        '' + a.getYear()
      )).replace('%m', c(a.getMonth() + 1, 2))).replace('%d', c(a.getDate(), 2))).replace(
        '%H',
        '' + c(a.getHours(), 2)
    ...
    (((e) => {
      ...
      ((e) => {
        ...
        e.ui.registry.addNestedMenuItem('insertdatetime', {
          ...
          text: 'Date/time',
          getSubmenuItems: () =>
            p.map(t, (t) => ({ type: 'menuitem', text: d(e, t), onAction: i(t) })),
          onSetup: g(e),
        });
      })(e));
  });
