!(function () {
  ...
  const l = (function () {
      ...
      var t = (function (e) {
        ...
        if (
          (d && ((s.filename = d.src), d.hasAttribute('data-manual') && (s.manual = !0)), !s.manual)
        ) {
       ...
       */ return (
        ...
        (function (e) {
          ...
          ((e.languages.csharp = e.languages.extend('clike', {
            ...
            e.languages.insertBefore('csharp', 'class-name', {
              namespace: {
                pattern: n(/(\b(?:namespace|using)\s+)<<0>>(?:\s*\.\s*<<0>>)*(?=\s*[;{])/.source, [
                  h,
                ]),
                lookbehind: !0,
                inside: { punctuation: /\./ },
              ...
              'generic-method': {
                ...
                inside: {
                  ...
                  generic: { pattern: RegExp(p), alias: 'class-name', inside: x },
                },
              },
              'type-list': {
                pattern: n(
        ...
        (t.languages.python['string-interpolation'].inside.interpolation.inside.rest =
          t.languages.python),
      ...
      e.windowManager.open({
        ...
        body: {
          ...
          items: [
            ...
            { type: 'textarea', name: 'code', label: 'Code view', spellcheck: !1 },
          ],
        },
        buttons: [
            ...
            e.undoManager.transact(() => {
              ...
              return (
                ...
                s.fold(
                  ...
                  (s) => {
                    (a.setAttrib(s, 'class', 'language-' + t),
                      (s.innerHTML = n),
                      g(e).highlightElement(s),
  ...
  e.add('codesample', (e) => {
    (((e) => {
      ...
      (t('codesample_languages', { processor: 'object[]' }),
        ...
        (e.on('PreProcess', (t) => {
          ...
          e.on('SetContent', () => {
            const t = e.dom,
              n = f.grep(
                t.select('pre'),
                (e) => p(e) && 'true' !== t.getAttrib(e, 'data-mce-highlighted')
              );
            n.length &&
              e.undoManager.transact(() => {
                f.each(n, (n) => {
                  (f.each(t.select('br', n), (n) => {
                    ...
                    (n.innerHTML = t.encode(n.textContent ?? '')),
          ...
          e.on('PreInit', () => {
            e.parser.addNodeFilter('pre', (e) => {
              for (let t = 0, n = e.length; t < n; t++) {
                const n = e[t];
                -1 !== (n.attr('class') ?? '').indexOf('language-') &&
                  (n.attr('contenteditable', 'false'), n.attr('data-mce-highlighted', 'false'));
              }
            });
          }));
      })(e),
